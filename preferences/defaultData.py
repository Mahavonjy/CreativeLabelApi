...
"""
from preferences import USER_ARTIST_DJ, USER_ARTIST_BEATMAKER, USER_ARTIST_MUSICIAN, USER_ARTIST_COMEDIAN, \
    USER_AUDIOVISUAL_SPECIALIST, USER_ARTIST_MAGICIAN, USER_ARTIST_DANCERS, USER_STREET_ARTIST, PENDING, ACCEPTED, \
    ...
    LIVE_SET, DJ_SET, MENTALISTS, MUSIC_VIDEO_EDITOR, PHOTOGRAPHERS, VIDEO_CLIP_DIRECTOR, OTHERS, PRESTIGE_MONEY, \
    ...
    DUBSTEP_ALLOWED, MAKOSSA_ALLOWED, TECHNO_ALLOWED, AFRO_POP_ALLOWED, REFUND_POLICY_STRICT, CAFE_PRESTIGE, \
    IMAGE_ALLOWED_TYPE_LOWERCASE_JPEG, FILE_ZIPPED, IMAGE_ALLOWED_TYPE_PNG, IMAGE_ALLOWED_TYPE_UPPERCASE_JPEG, \
    MUSICAL_GENRE_MUSIC, MUSICAL_GENRE_BEATS, ALLOWED_MUSIC_WAV, ALLOWED_MUSIC_MPEG, BASY_MENA_PRESTIGE, MALESA_ALLOWED
