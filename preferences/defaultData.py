...
"""
from preferences import BASIC_LICENSE, GOLD_LICENSE, PLATINUM_LICENSE, SILVER_LICENSE, USER_ARTIST_DJ, \
    USER_ARTIST_BEATMAKER, USER_ARTIST_MUSICIAN, USER_ARTIST_COMEDIAN, USER_AUDIOVISUAL_SPECIALIST, \
    USER_ARTIST_MAGICIAN, USER_ARTIST_DANCERS, USER_STREET_ARTIST, PENDING, ACCEPTED, \
    DECLINED, FR, USER_STREET_ARTIST_FR, USER_ARTIST_DANCERS_FR, USER_ARTIST_MAGICIAN_FR, ALLOWED_MUSIC_WAVE, \
    USER_AUDIOVISUAL_SPECIALIST_FR, USER_ARTIST_COMEDIAN_FR, USER_ARTIST_MUSICIAN_FR, USER_ARTIST_BEATMAKER_FR, \
    USER_ARTIST_DJ_FR, MARIAGE, TRADITIONAL_PARTY, BIRTHDAY_PARTY, SHOW_CASE, FESTIVAL, SPORT_EVENTS, CAMERAMAN, \
    ENTERPRISE_EVENTS, CREATE_BEATS, ASSOCIATION_EVENTS, VIDEO_EDITOR, ANIMATOR, CLOSE_UP, PRESTIDIGITATORS, MIX, \
    LIVE_SET, DJ_SET, MENTALISTS, MUSIC_VIDEO_EDITOR, PHOTOGRAPHERS, VIDEO_CLIP_DIRECTOR, OTHERS, \
    BURLESQUE, CLOWN, COMEDY, STORYTELLER, BALANCE_TRAINERS, HUMORIST, EXPERIMENTAL, DRAMA, IMITATOR, PUPPETEER, \
    FIRE_EATERS, ACROBATE, STAND_UP, JUGGLER, JAZZ_ALLOWED, KOMPAS_ALLOWED, VAKODRAZANA_ALLOWED, KAWITRY_ALLOWED, \
    BATRELAKY_ALLOWED, SALEGY_ALLOWED, NDOMBOLO_ALLOWED, KIZOMBA_ALLOWED, CONTEMPORARY, BACHATA, ZOUK_LOVE_ALLOWED, \
    MIME, CAPOEIRA, CHACHACHA, KILALAKY_ALLOWED, MALOYA_ALLOWED, IMPROVISATION, HIP_HOP_ALLOWED, SAMBA_ALLOWED, \
    ETHNIQUE, ORIENTAL, CLASSIC, MODERN, SALSA, TANGO, AFROBEAT_ALLOWED, BREAKBEAT_ALLOWED, BLUES_ALLOWED, \
    REGGAE_MUFFIN_ALLOWED, METAL_ALLOWED, FOLK_ALLOWED, ELECTRONICA_ALLOWED, CLASSIQUE_ALLOWED, REGGAETON_ALLOWED, \
    COUPE_DECALE_ALLOWED, ALLOWED_MUSIC_MP3, TSAPIKY_ALLOWED, ZAFINDRAONA_ALLOWED, POP_ALLOWED, SLOW_ALLOWED, \
    KUDURO_ALLOWED, FUNK_ALLOWED, DANCEHALL_ALLOWED, GOSPEL_ALLOWED, HOUSE_ALLOWED, SLAM_ALLOWED, SWING_ALLOWED, \
    SOUL_ALLOWED, RAP_ALLOWED, REGGAE_ALLOWED, ROCK_ALLOWED, RUMBA_ALLOWED, BASESA_ALLOWED, HIRA_GASY_ALLOWED, \
    AFRO_TRAP_ALLOWED, RNB_ALLOWED, REMIX_ALLOWED, GOMA_ALLOWED, REFUND_POLICY_FLEXIBLE, ACAPELLA_ALLOWED, \
    DUBSTEP_ALLOWED, MAKOSSA_ALLOWED, TECHNO_ALLOWED, AFRO_POP_ALLOWED, REFUND_POLICY_STRICT, \
    IMAGE_ALLOWED_TYPE_LOWERCASE_JPEG, FILE_ZIPPED, IMAGE_ALLOWED_TYPE_PNG, IMAGE_ALLOWED_TYPE_UPPERCASE_JPEG, \
    ALLOWED_MUSIC_WAV, ALLOWED_MUSIC_MPEG, MALESA_ALLOWED
...
allowed_beats_license = [BASIC_LICENSE, SILVER_LICENSE, GOLD_LICENSE, PLATINUM_LICENSE]
