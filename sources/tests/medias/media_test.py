...
from preferences import AFROBEAT_ALLOWED, BLUES_ALLOWED, USER_ARTIST_BEATMAKER
...
class TestMedia(Test):
    ...
    def test_update_beat(self):
        ...
        self.beat.update({'title': 'toto', 'photo': None, 'file': None, 'beats_wave': None, 'stems': None})
