...
class AlbumSchema(ValidateSchema):
    ...
    album_photo = fields.Str(nullable=True)
    album_id = fields.Str(nullable=True)
    genre_musical = fields.Str(required=True)
    genre = fields.Str(required=True)
    number_songs = fields.Int(nullable=True)
    stream_total = fields.Int(nullable=True)
    user_id = fields.Int(nullable=True)
    keys = fields.Int(nullable=True)
