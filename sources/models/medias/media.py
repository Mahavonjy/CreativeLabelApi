...
class MediaSchema(ValidateSchema):
    ...
    beats_wave = fields.Str(allow_none=True)
    genre = fields.Str(required=True)
    genre_musical = fields.Str(required=True)
    storage_name = fields.Str(allow_none=True)
    photo = fields.Str(allow_none=True)
    album_id = fields.Int(allow_none=True)
    ...
    in_playlist = fields.Int(allow_none=True)
    number_play = fields.Int(allow_none=True)
    pres_listened = fields.Int(allow_none=True)
    album_song = fields.Int(allow_none=True)
