...
class PaymentHistorySchema(ValidateSchema):
    ...
    licenses_name = fields.Str(allow_none=True)
    paid = fields.Boolean(allow_none=True)
    service_fee = fields.Boolean(allow_none=True)
    refund = fields.Boolean(allow_none=True)
